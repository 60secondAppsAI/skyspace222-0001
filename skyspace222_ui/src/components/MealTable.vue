...
<template>
  ...
  <base-input label="DietaryType" type="text" placeholder="Enter DietaryType" v-model="mealToAdd.dietaryType"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'dietaryType',
          visible: true,
          scopedSlots: { customRender: 'dietaryType' },
          sorter: true
          //sorter: (a, b) => a.dietaryType - b.dietaryType,
          //sorter: (a, b) => a.dietaryType.localeCompare(b.dietaryType),
        },
      ],
      pagination: {
        current: 1,
