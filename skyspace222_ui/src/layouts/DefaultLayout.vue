...
-->>
				...
				<a-menu-item>
					<router-link to="/routePlans">
						<span class="label">Route Plans</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/cabinClasss">
						<span class="label">Cabin Classs</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/flightCabins">
						<span class="label">Flight Cabins</span>
					</router-link>
				</a-menu-item>
